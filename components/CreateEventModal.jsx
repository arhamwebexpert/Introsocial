...
export default function CreateEventModal({ groupId, onClose, onCreated }) {
    const [form, setForm] = useState({
        title: '', description: '', location: '', dateTime: '', visibility: 'public',
    });
        ...
        <div style={{
            ...
            <div className="fb-card" style={{ width: '100%', maxWidth: '440px', background: 'var(--fb-surface)' }}>
                <div style={{ padding: '1.25rem' }}>
                    {/* Header */}
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.25rem', paddingBottom: '1rem', borderBottom: '1px solid var(--fb-border)' }}>
                        <h2 style={{ margin: 0, fontSize: '1.125rem', fontWeight: '700', color: 'var(--fb-text)' }}>📅 Create Event</h2>
                        <button
                            onClick={onClose}
                            style={{
                    ...
                    <form onSubmit={handleSubmit}>
                        <div style={{ marginBottom: '0.875rem' }}>
                            <label style={{ display: 'block', fontSize: '0.8125rem', fontWeight: '600', color: 'var(--fb-text-secondary)', marginBottom: '0.375rem' }}>Title *</label>
                        ...
                        <div style={{ marginBottom: '0.875rem' }}>
                            ...
                            <textarea name="description" placeholder="What's happening?" rows={2}
