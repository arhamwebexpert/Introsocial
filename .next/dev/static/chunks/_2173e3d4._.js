...
_s(MomentCard, "wdUojFfc3DAYVADcatwV4v88WCI=");
_c3 = MomentCard;
var _c, _c1, _c2, _c3;
...
function GroupFeedPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GroupFeedPage.useEffect": ()=>{
            if (!user || !id) return;
            fetch(`/api/groups/${id}`).then({
                "GroupFeedPage.useEffect": (r)=>r.json()
            }["GroupFeedPage.useEffect"]).then({
                "GroupFeedPage.useEffect": (data)=>{
                    if (data.error) {
                        setError(data.error);
                        return;
                    }
            ...
            }["GroupFeedPage.useEffect"]).catch({
                "GroupFeedPage.useEffect": ()=>setError('Failed to load group')
            }["GroupFeedPage.useEffect"]);
        }
    }["GroupFeedPage.useEffect"], [
        user,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GroupFeedPage.useEffect": ()=>{
            if (!user || !id) return;
            fetch(`/api/moments?groupId=${id}`).then({
                "GroupFeedPage.useEffect": (r)=>r.json()
            }["GroupFeedPage.useEffect"]).then({
                "GroupFeedPage.useEffect": (data)=>setMoments(data.moments || [])
            }["GroupFeedPage.useEffect"]).catch({
                "GroupFeedPage.useEffect": ()=>{}
            }["GroupFeedPage.useEffect"]).finally({
                "GroupFeedPage.useEffect": ()=>setFetching(false)
            }["GroupFeedPage.useEffect"]);
        }
    }["GroupFeedPage.useEffect"], [
        user,
...
_s(GroupFeedPage, "sgyqKeVTW8/dWSnhrhfsFpEQA7I=", false, function() {
    return [
...
__turbopack_context__.k.register(_c1, "BackIcon");
__turbopack_context__.k.register(_c2, "GroupFeedPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_2173e3d4._.js.map