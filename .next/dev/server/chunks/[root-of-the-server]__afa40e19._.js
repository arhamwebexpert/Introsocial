...
"[project]/models/Message.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__ = __turbopack_context__.i("[externals]/mongoose [external] (mongoose, cjs, [project]/node_modules/mongoose)");
;
const MessageSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__["default"].Schema({
    groupId: {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Message$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/models/Message.js [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Event$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/models/Event.js [app-route] (ecmascript)"); // ← ADD THIS LINE
...
async function GET(request) {
    try {
        ...
        const group = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Group$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(groupId);
        if (!group) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Group not found'
        }, {
            status: 404
        });
        const isMember = group.members.some((m)=>m.toString() === user.userId);
        if (!isMember) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Access denied'
        }, {
            status: 403
        });
        // Only fetch root messages (parentId is null)
        const messages = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Message$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
            groupId,
            parentId: null
        }).populate('userId', 'name email').populate('promotedToEvent').sort({
            createdAt: 1
        }); // oldest first for chat feel
...
async function POST(request) {
    try {
        ...
        const message = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Message$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            groupId,
            userId: user.userId,
            text: text.trim()
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__afa40e19._.js.map