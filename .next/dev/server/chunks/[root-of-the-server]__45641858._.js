...
"[project]/app/api/groups/join/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const group = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Group$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
        ...
        const alreadyMember = group.members.some((id)=>id.toString() === user.userId);
        if (alreadyMember) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__45641858._.js.map