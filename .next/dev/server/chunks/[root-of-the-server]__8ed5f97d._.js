...
"[project]/app/api/messages/[id]/reply/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const replies = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Message$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
            parentId: id
...
async function POST(request, { params }) {
    try {
        ...
        if (!text?.trim()) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'text is required'
        }, {
            status: 400
        });
        // Find parent message to get groupId
        const parent = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Message$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(id);
        if (!parent) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Message not found'
        }, {
            status: 404
        });
        // Create reply
        const reply = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Message$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8ed5f97d._.js.map