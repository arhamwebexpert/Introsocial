...
"[project]/models/Moment.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const MomentSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__["default"].Schema({
    imageUrl: {
        type: String,
        required: [
            true,
...
const __TURBOPACK__default__export__ = __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__["default"].models.Moment || __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__["default"].model("Moment", MomentSchema);
}),
...
"[project]/app/api/moments/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Moment$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/models/Moment.js [app-route] (ecmascript)");
...
async function GET(request) {
    try {
        ...
        if (groupId) {
            ...
            const userGroups = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Group$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
                members: user.userId
            }).select('_id');
        ...
        const moments = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Moment$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find(query).populate('userId', 'name email').populate('groupId', 'name') // Helpful for displaying the group name in the feed
        .sort({
            createdAt: -1
        });
...
async function POST(request) {
    try {
        ...
        if (!imageUrl || !groupId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'imageUrl and groupId are required'
            }, {
                status: 400
            });
        }
        const moment = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Moment$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            imageUrl,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b8bc1b4f._.js.map